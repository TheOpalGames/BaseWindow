package net.theopalgames.basewindow.lwjgl;

//import basewindow.BaseSoundPlayer;
import org.apache.commons.io.IOUtils;
import net.theopalgames.basewindow.BaseSoundPlayer;
...
public class LwjglSoundPlayer extends BaseSoundPlayer
{
    ...
    public Map<String, Integer> buffers = new HashMap<>();
    public List<Integer> sources = new ArrayList<>();

    public Map<String, Integer> musicBuffers = new HashMap<>();
    public List<Integer> musicSources = new ArrayList<>();
